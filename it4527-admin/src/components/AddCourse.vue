  ...
  methods: {
    ...
    onSubmit: async function(event) {
        ...
        .then(function (response) {
            ...
            _this.contract.methods.addCourse(_this.form.id, _this.form.code, _this.form.name, _this.form.date, _this.form.issuer, ipfsHash).send({from: _this.account, gas:3000000})
